    ...
    <table style="border:none; margin: 0; padding: 0;">
        <tr style="border:none;">
            ...
            <td style="width: 50%; text-align: center; border:none; padding: 0; vertical-align:middle;">
                <h1 style="font-size: 15px; margin: 0; line-height: 1.3;">GAZ TESİSATI GÜVENLİĞİ<br>PERİYODİK KONTROL RAPORU</h1>
            </td>
            <td style="width: 30%; border:none; padding: 0;">
                <table class="doc-info" style="border:1px solid black; width:100%; margin: 0;">
                    <tr>
                        ...
                        <td style="border:1px solid black; padding: 2px 4px; font-size: 9px;">GTPKR01</td>
                    </tr>
                    <tr>
...
<head>
    <meta charset="UTF-8">
    <title>Gaz Tesisatı Raporu: <?php echo htmlspecialchars($data['report_no']); ?></title>
    ...
    <style>
        ...
        .section-title-bg {
            background-color: #ebf1de; /* Light Green theme for Gas */
            font-weight: bold;
            text-align: left;
            padding: 4px 8px;
                ...
                <td style="border:none; padding:0;">
                    <div class="page">
                        ...
                        <div class="result-box-compact bg-light-gray" style="min-height: 25px; padding: 4px 6px;">
                            <?php echo !empty($data['defects']) ? nl2br(htmlspecialchars($data['defects'])) : 'Gaz tesisatı yönünden herhangi bir uygunsuzluk tespit edilmemiştir.'; ?>
                        </div>

                        <!-- 4. SONUÇ -->
                        <div class="section-title-bg">4. SONUÇ</div>
                        <div class="result-box-compact" style="padding: 4px 6px;">
                            Yukarıda tespit ve değerlendirme sorularına göre adı geçen tesis Gaz Tesisatı yönünden 
