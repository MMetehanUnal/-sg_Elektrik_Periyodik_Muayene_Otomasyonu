                            ...
                            <tr>
                                <td style="width: 70%; vertical-align: top; border: none;">
                                    <table class="compact-inner-table">
                                        <tr>
                                            <td colspan="2" class="header-bg fw-bold text-center" style="background-color: #fce4d6; padding: 4px; font-size: 10px;">Periyodik Kontrolü Yapmaya Yetkili Kişinin</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td class="header-bg fw-bold">Diploma Tarihi ve Numarası</td>
