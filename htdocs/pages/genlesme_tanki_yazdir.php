...
// Fetch Genlesme Tanki Report Data
$stmt = $pdo->prepare("
    SELECT r.*, 
    ...
    <table style="border:none; margin: 0; padding: 0;">
        <tr style="border:none;">
            ...
            <td style="width: 50%; text-align: center; border:none; padding: 0; vertical-align:middle;">
                <h1 style="font-size: 14px; margin: 0; line-height: 1.3;">GENLEŞME TANKI<br>PERİYODİK KONTROL RAPORU</h1>
            </td>
            <td style="width: 30%; border:none; padding: 0;">
                <table class="doc-info" style="border:1px solid black; width:100%; margin: 0;">
                    <tr>
                        ...
                        <td style="border:1px solid black; padding: 2px 4px; font-size: 9px;">GTPKR02</td>
                    </tr>
                    <tr>
...
<head>
    <meta charset="UTF-8">
    <title>Genleşme Tankı Raporu: <?php echo htmlspecialchars($data['report_no']); ?></title>
            ...
            <tr>
                <td style="border:none; padding:0;">
                    <div class="page">
                        ...
                        <table>
                            ...
                            <tbody>
                                <?php foreach ($donanim_keys as $key => $label): 
                                    ...
                                    $amount = $tank_donanimlari[$key]['amount'] ?? '-';
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center fw-bold" style="width: 20%;">
                                            <?php 
                                                if ($is_title) {
                                                    ...
                                                    // Convert evaluation label on display if necessary
                                                    if ($val == 'UYGUN') {
                        ...
                        <!-- 8. KONTROLÜ GERÇEKLEŞTİREN YETKİLİ KİŞİ BİLGİLERİ VE ONAY -->
                        <div class="fw-bold" style="margin-top: 8px; margin-bottom: 2px;">8. KONTROLÜ GERÇEKLEŞTİREN YETKİLİ KİŞİ BİLGİLERİ VE ONAY :</div>
