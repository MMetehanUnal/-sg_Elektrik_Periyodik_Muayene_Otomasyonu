...
$questions = [
    ...
    'q12' => 'Merkezi Sıcak Su tesisatında Lejonella riskine karşı tedbir alınmış mı? Kullanım sıcak su sisteminin azami sıcaklık sınırlamalarına dikkat edilmekte mi? (Sıcak su tanklarında bulunan suyun sıcaklığı en az 60°C, geri dönen su en az 50°C)',
    ...
    <table style="border:none; margin: 0; padding: 0;">
        <tr style="border:none;">
            ...
            <td style="width: 50%; text-align: center; border:none; padding: 0; vertical-align:middle;">
                <h1 style="font-size: 15px; margin: 0; line-height: 1.3;">SIHHİ TESİSAT GÜVENLİĞİ<br>PERİYODİK KONTROL RAPORU</h1>
            </td>
            <td style="width: 30%; border:none; padding: 0;">
                <table class="doc-info" style="border:1px solid black; width:100%; margin: 0;">
                    <tr>
                        ...
                        <td style="border:1px solid black; padding: 2px 4px; font-size: 9px;">STPKR01</td>
                    </tr>
                    <tr>
...
<head>
    <meta charset="UTF-8">
    <title>Sıhhi Tesisat Raporu: <?php echo htmlspecialchars($data['report_no']); ?></title>
    ...
    <style>
        ...
        @media print {
            ...
            /* Prevent orphan headings and page splits */
            ...
            <tr>
                <td style="border:none; padding:0;">
                    <div class="page">
                        ...
                        <!-- 3. ÖNERİLER (Compact size matching PDF) -->
                        ...
                        <div class="result-box-compact bg-light-gray" style="min-height: 25px; padding: 4px 6px;">
                            <?php echo !empty($data['defects']) ? nl2br(htmlspecialchars($data['defects'])) : 'Sıhhi tesisat yönünden herhangi bir uygunsuzluk tespit edilmemiştir.'; ?>
                        </div>

                        <!-- 4. SONUÇ (Compact size matching PDF) -->
                        <div class="section-title-bg">4. SONUÇ</div>
                        <div class="result-box-compact" style="padding: 4px 6px;">
                            Yukarıda tespit ve değerlendirme sorularına göre adı geçen tesis Sıhhi Tesisat yönünden 
